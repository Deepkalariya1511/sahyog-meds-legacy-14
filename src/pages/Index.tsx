...
const Index = () => {
  return (
    <div className="min-h-screen bg-background">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8 animate-fade-in">
              <div>
                ...
                <h1 className="text-3xl sm:text-4xl lg:text-6xl font-bold text-foreground mb-4 sm:mb-6 leading-tight animate-slide-up">
                  Your Health,
                  <span className="bg-gradient-to-r from-primary via-primary-glow to-secondary bg-clip-text text-transparent animate-pulse-glow block sm:inline">
                    {" "}Our Priority
                  </span>
                </h1>
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-3 sm:space-y-0 sm:space-x-6 pt-4">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-xs sm:text-sm text-muted-foreground">Jetpur-360370</span>
                </div>
                <div className="flex items-center space-x-2">
                  <Clock className="w-4 sm:w-5 h-4 sm:h-5 text-secondary flex-shrink-0" />
                  <span className="text-xs sm:text-sm text-muted-foreground">8 AM - 9 PM</span>
                </div>
              </div>
            </div>

            <div className="relative animate-slide-up mt-8 lg:mt-0" style={{animationDelay: '0.3s'}}>
              ...
              <div className="absolute -bottom-4 sm:-bottom-6 -left-4 sm:-left-6 bg-white/90 backdrop-blur-sm rounded-xl p-3 sm:p-4 shadow-lg border border-white/50 hover:scale-105 transition-transform duration-300">
                <div className="flex items-center space-x-2 sm:space-x-3">
                  <div className="w-8 h-8 sm:w-12 sm:h-12 bg-white rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-shadow duration-300">
                    <img src={sahyogLogo} alt="Sahyog Medical Store" className="w-5 h-5 sm:w-8 sm:h-8 object-contain" />
                  </div>
                  <div>
                    <p className="text-sm sm:text-base font-semibold text-foreground">23+ Years</p>
                    <p className="text-xs sm:text-sm text-muted-foreground">Trusted Service</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            <Card className="border-0 bg-gradient-to-br from-card to-medical-light-blue hover:shadow-xl transition-all duration-500 hover:scale-105 hover:-translate-y-2 group animate-fade-in">
              <CardHeader className="pb-4">
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-primary/10 rounded-lg flex items-center justify-center mb-3 sm:mb-4 group-hover:scale-110 transition-transform duration-300 group-hover:bg-primary/20">
                  <Pill className="w-5 h-5 sm:w-6 sm:h-6 text-primary" />
                </div>
                <CardTitle className="text-lg sm:text-xl">Prescription Medicines</CardTitle>
              </CardHeader>
            ...
            <Card className="border-0 bg-gradient-to-br from-card to-medical-light-green hover:shadow-xl transition-all duration-500 hover:scale-105 hover:-translate-y-2 group animate-fade-in" style={{animationDelay: '0.2s'}}>
              <CardHeader className="pb-4">
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-secondary/10 rounded-lg flex items-center justify-center mb-3 sm:mb-4 group-hover:scale-110 transition-transform duration-300 group-hover:bg-secondary/20">
                  <Shield className="w-5 h-5 sm:w-6 sm:h-6 text-secondary" />
                </div>
                <CardTitle className="text-lg sm:text-xl">OTC Medications</CardTitle>
              </CardHeader>
              <CardContent className="pt-0">
                <p className="text-sm sm:text-base text-muted-foreground">
            ...
            <Card className="border-0 bg-gradient-to-br from-card to-primary/5 hover:shadow-xl transition-all duration-500 hover:scale-105 hover:-translate-y-2 group animate-fade-in sm:col-span-2 lg:col-span-1" style={{animationDelay: '0.4s'}}>
              <CardHeader className="pb-4">
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-primary/10 to-secondary/10 rounded-lg flex items-center justify-center mb-3 sm:mb-4 group-hover:scale-110 transition-transform duration-300 group-hover:bg-gradient-to-br group-hover:from-primary/20 group-hover:to-secondary/20">
                  <Stethoscope className="w-5 h-5 sm:w-6 sm:h-6 text-primary" />
                </div>
                <CardTitle className="text-lg sm:text-xl">Health Consultations</CardTitle>
              </CardHeader>
              <CardContent className="pt-0">
                <p className="text-sm sm:text-base text-muted-foreground">
            ...
            <div className="order-2 lg:order-1">
              ...
              <div className="space-y-3 sm:space-y-4 mb-6 sm:mb-8">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-sm sm:text-base text-muted-foreground">Authentic medicines guaranteed</span>
                </div>
                <div className="flex items-center space-x-3">
                  <CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-secondary flex-shrink-0" />
                  <span className="text-sm sm:text-base text-muted-foreground">Expert pharmacist guidance</span>
                </div>
                <div className="flex items-center space-x-3">
                  <CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-primary flex-shrink-0" />
                  <span className="text-sm sm:text-base text-muted-foreground">Competitive pricing</span>
                </div>
                <div className="flex items-center space-x-3">
                  <CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-secondary flex-shrink-0" />
                  <span className="text-sm sm:text-base text-muted-foreground">Emergency medicine availability</span>
                </div>
              </div>
            ...
            <div className="space-y-6 order-1 lg:order-2">
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 group">
                ...
                <div className="absolute bottom-3 sm:bottom-4 left-3 sm:left-4 text-white">
                  <p className="text-xs sm:text-sm font-medium drop-shadow-lg">Our Store Today</p>
              ...
              <div className="grid grid-cols-2 gap-3 sm:gap-4">
                <Card className="border-0 bg-gradient-to-br from-primary/10 to-primary/20 hover:shadow-lg hover:scale-105 transition-all duration-300 animate-fade-in">
                  <CardContent className="p-3 sm:p-4 text-center">
                    <div className="text-xl sm:text-2xl font-bold text-primary mb-1 animate-pulse-glow">23+</div>
                ...
                <Card className="border-0 bg-gradient-to-br from-secondary/10 to-secondary/20 hover:shadow-lg hover:scale-105 transition-all duration-300 animate-fade-in" style={{animationDelay: '0.1s'}}>
                  <CardContent className="p-3 sm:p-4 text-center">
                    <div className="text-xl sm:text-2xl font-bold text-secondary mb-1">5000+</div>
                ...
                <Card className="border-0 bg-gradient-to-br from-secondary/10 to-secondary/20 hover:shadow-lg hover:scale-105 transition-all duration-300 animate-fade-in" style={{animationDelay: '0.2s'}}>
                  <CardContent className="p-3 sm:p-4 text-center">
                    <div className="text-xl sm:text-2xl font-bold text-secondary mb-1">24/7</div>
      ...
      {/* CTA Section */}
      <section className="py-12 sm:py-16 bg-gradient-to-r from-primary/10 via-background to-secondary/10">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            <div className="text-center sm:text-left">
              <div className="flex items-center justify-center sm:justify-start space-x-2 mb-3 sm:mb-4">
                <div className="flex h-8 w-8 sm:h-10 sm:w-10 items-center justify-center rounded-lg bg-white shadow-md">
                  <img src={sahyogLogo} alt="Sahyog Medical Store" className="h-5 w-5 sm:h-6 sm:w-6 object-contain" />
                </div>
                <div>
                  <h3 className="text-sm sm:text-base font-bold text-foreground">Sahyog Medical Store</h3>
